# Copyright (C) 2019 the white spidy LLC.
#
# Licensed under the spidy Public License, Version 1.c (the "License");
...
API_KEY = os.environ.get("API_KEY", "2725237")
API_HASH = os.environ.get("API_HASH", "ae3df8e018807d2b64850df39f67b0ae")
